...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./opt/lampp/htdocs/JWTTokenProject/JWTTokenProject/public/storage' => 'string',
            'jwt.secret' => 'string',
...
'auth.guards.web.provider','auth.guards.api.driver','auth.guards.api.provider','auth.guards.api.auth','auth.guards.sanctum.driver',
...
'filesystems.disks.s3.report','filesystems.links./opt/lampp/htdocs/JWTTokenProject/JWTTokenProject/public/storage','jwt.secret','jwt.keys.public','jwt.keys.private',
